		...
		public static class BezierLerp
		{
			...
			public static Vector3 Lerp(BezierCurveV3D curve, float time)
			{
				switch(curve.Positions.Count)
				{
					...
					case 1: return curve.Positions[0];
					case 2: return Lerps.Lerp(curve.Positions[0], curve.Positions[1], time);
					case 3: return Lerp(curve.Positions[0], curve.Positions[1], curve.Positions[2], time);
					case 4: return Lerp(curve.Positions[0], curve.Positions[1], curve.Positions[2], curve.Positions[3],                                       time);
					case 5: return Lerp(curve.Positions[0], curve.Positions[1], curve.Positions[2], Lerps.Lerp(curve.Positions[3], curve.Positions[4], time), time);
				}

				//FROM HERE IS IS SAFE
				//For there to be at leat 5 hard coded positions
				var count    = curve.Positions.Count;
