...
public class LocalizationMasterComponent : SingletonCrate<LocalizationMasterComponent>
{
    ...
    public static string FilePath{get {return Application.streamingAssetsPath + "/Localization/"; } }
...
public class LangFile
{
    ...
    {
        LanguageData.Clear();
        foreach (var VARIABLE in data.DictionaryData.Data) LanguageData.Add(VARIABLE.Key, VARIABLE.Data);
    }
}